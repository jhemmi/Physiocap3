...
La version 3.1.3-INTRA_GDAL est publiée dans le dépot github. 
La 3.1.0-INTRA_GDAL est déposéé sous QGIS 3 (accessible directement dans QGIS 3 depuis le Menu "Extension").

**Attention, ce dépot GitHub contient la version en cours d'évolution (la 3.1.4 - Avril 2018 https://github.com/jhemmi/Physiocap3/releases) **

**Warning, this GitHub repo contains last evolution version (Version  3.1.4 - April 2018 https://github.com/jhemmi/Physiocap3/releases) **
