...
from .Physiocap3_dialog import Physiocap3Dialog
import os.path
...
class Physiocap3:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr('&Physiocap3')
        # We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar('Physiocap3')
        self.toolbar.setObjectName('Physiocap3')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Physiocap3', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/Physiocap3/icon.png'
        self.add_action(
            icon_path,
            text=self.tr('Physiocap3'),
            callback=self.run,
