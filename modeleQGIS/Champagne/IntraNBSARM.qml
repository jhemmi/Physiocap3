    ...
    <rasterrenderer alphaBand="-1" type="singlebandpseudocolor" band="1" classificationMin="7.4" classificationMax="25" opacity="1">
      ...
      <rastershader>
        <colorrampshader clip="0" classificationMode="1" colorRampType="DISCRETE">
          ...
          <item color="#e9e9d8" label="NBSARM &lt; 3" alpha="255" value="3"/>
          <item color="#eff797" label="3 &lt; NBSARM &lt; 5.8" alpha="255" value="5.8"/>
          <item color="#9dd798" label="5.8 &lt; NBSARM &lt; 6.3" alpha="255" value="6.3"/>
          <item color="#54b466" label="6.3 &lt; NBSARM &lt; 6.8" alpha="255" value="6.8"/>
          <item color="#1d9340" label="6.8 &lt; NBSARM &lt; 7.4" alpha="255" value="7.4"/>
          <item color="#00741f" label="7.4 &lt; NBSARM &lt; 8" alpha="255" value="8"/>
          <item color="#244d7a" label="8 &lt; NBSARM &lt; 9" alpha="255" value="9"/>
          <item color="#67387a" label="9 &lt; NBSARM &lt; 10" alpha="255" value="10"/>
          <item color="#78205d" label="10 &lt; NBSARM &lt; 11" alpha="255" value="11"/>
          <item color="#5e0440" label="11 &lt; NBSARM " alpha="255" value="30"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
