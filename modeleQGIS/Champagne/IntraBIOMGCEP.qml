    ...
    <rasterrenderer type="singlebandpseudocolor" opacity="1" band="1" classificationMin="110" classificationMax="inf" alphaBand="-1">
      ...
      <rastershader>
        <colorrampshader colorRampType="DISCRETE" clip="0" classificationMode="2">
          ...
          <item alpha="255" value="107" color="#eff797" label="Très faible : &lt;= 107"/>
          <item alpha="255" value="313" color="#ddf2d7" label="Faible : entre 107 et 313"/>
          <item alpha="255" value="396" color="#b2e0ab" label="Moyenne - : entre 313 et 396"/>
          <item alpha="255" value="474" color="#3da75a" label="Moyenne + : entre 396 et 474"/>
          <item alpha="255" value="712" color="#38578c" label="Elevée : entre 474 et 712"/>
          <item alpha="255" value="inf" color="#440154" label="Très élevée : > 712"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
