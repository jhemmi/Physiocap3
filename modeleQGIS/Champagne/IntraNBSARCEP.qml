    ...
    <rasterrenderer type="singlebandpseudocolor" opacity="1" band="1" classificationMin="110" classificationMax="inf" alphaBand="-1">
      ...
      <rastershader>
        <colorrampshader colorRampType="DISCRETE" clip="0" classificationMode="2">
          ...
          <item alpha="255" value="3.6" color="#eff797" label="Très faible : &lt;= 3.6"/>
          <item alpha="255" value="7.0" color="#ddf2d7" label="Faible : entre 3.6 et 7.0"/>
          <item alpha="255" value="8.2" color="#b2e0ab" label="Moyenne - : entre 7.0 et 8.2"/>
          <item alpha="255" value="9.5" color="#3da75a" label="Moyenne + : entre 8.2 et 9.5"/>
          <item alpha="255" value="13.3" color="#38578c" label="Elevée : entre 9.5 et 13.3"/>
          <item alpha="255" value="inf" color="#440154" label="Très élevée : > 13.3"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
