    ...
    <rasterrenderer type="singlebandpseudocolor" opacity="1" band="1" classificationMin="110" classificationMax="inf" alphaBand="-1">
      ...
      <rastershader>
        <colorrampshader colorRampType="DISCRETE" clip="0" classificationMode="2">
          ...
          <item alpha="255" value="2.7" color="#eff797" label="Très faible : &lt;= 2.7"/>
          <item alpha="255" value="5.3" color="#ddf2d7" label="Faible : entre 2.7 et 5.3"/>
          <item alpha="255" value="6.2" color="#b2e0ab" label="Moyenne - : entre 5.3 et 6.2"/>
          <item alpha="255" value="7.2" color="#3da75a" label="Moyenne + : entre 6.2 et 7.2"/>
          <item alpha="255" value="10.1" color="#38578c" label="Elevée : entre 7.2 et 10.1"/>
          <item alpha="255" value="inf" color="#440154" label="Très élevée : > 10.1"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
