...
class QgisInterface(QObject):
    ...
    def __init__(self, canvas):
        ...
        mon_projet.layersAdded.connect(self.addLayers)
        # noinspection PyArgumentList
        mon_projet.layerWasAdded.connect(self.addLayer)
        # noinspection PyArgumentList
        mon_projet.removeAll.connect(self.removeAllLayers)
