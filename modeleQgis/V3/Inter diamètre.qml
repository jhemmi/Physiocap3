...
<qgis simplifyMaxScale="1" simplifyDrawingHints="1" simplifyLocal="1" readOnly="0" maxScale="-4.65661e-10" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" version="2.99.0-Master" mincale="1e+8" simplifyAlgorithm="0">
  <renderer-v2 forceraster="0" enableorderby="0" attr="DIAM" symbollevels="0" type="graduatedSymbol" graduatedMethod="GraduatedColor">
    <ranges>
      <range label="4 - 8" lower="4.000000000000000" render="true" symbol="0" upper="8.000000000000000"/>
      <range label="8- 12" lower="8.000000000000000" render="true" symbol="1" upper="12.000000000000000"/>
      <range label="12 - 16 " lower="12.000000000000000" render="true" symbol="2" upper="16.000000000000000"/>
      <range label="16 - 20" lower="16.000000000000000" render="true" symbol="3" upper="20.000000000000000"/>
    </ranges>
    <symbols>
      ...
      <symbol name="1" clip_to_extent="1" alpha="1" type="fill">
        <layer locked="0" class="SimpleFill" pass="0" enabled="1">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="253,188,130,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
  ...
  <labeling type="simple">
    <settings>
      ...
      <placement offsetUnits="MapUnit" offsetType="0" preserveRotation="1" distMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placement="0" fitInPolygonOnly="0" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" repeatDistance="0" distUnits="MM" priority="5" repeatDistanceUnits="MM" maxCurvedCharAngleOut="-20" yOffset="0" rotationAngle="0" placementFlags="0" maxCurvedCharAngleIn="20" dist="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" xOffset="0"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory labelPlacementMethod="XHeight" height="15" width="15" minScaleDenominator="-4.65661e-10" rotationOffset="270" maxScaleDenominator="1e+8" penWidth="0" opacity="1" scaleBasedVisibility="0" lineSizeScale="3x:0,0,0,0,0,0" diagramOrientation="Up" scaleDependency="Area" barWidth="5" penColor="#000000" penAlpha="255" lineSizeType="MM" minimumSize="0" sizeScale="3x:0,0,0,0,0,0" backgroundColor="#ffffff" backgroundAlpha="255" enabled="0" sizeType="MM">
