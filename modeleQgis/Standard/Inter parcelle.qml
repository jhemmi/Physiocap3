    ...
    <symbols>
      <symbol name="0" clip_to_extent="1" alpha="1" type="fill">
        <layer locked="0" class="SimpleFill" pass="0" enabled="1">
          ...
          <prop v="0,236,246,255" k="outline_color"/>
